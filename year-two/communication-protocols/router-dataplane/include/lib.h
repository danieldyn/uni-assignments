...
#define ROUTING_TABLE_SIZE 100000
#define ROUTING_TABLE_PATH argv[1] // This is consistent with the Makefile run_router rule
#define ARP_TABLE_SIZE 100

/* Useful typedefs */
typedef struct route_table_entry RTableEntry;
typedef struct route_table_entry *RTable;
typedef struct arp_table_entry ArpTableEntry;
typedef struct arp_table_entry *ArpTable;
typedef struct packet QueuePacket;

/**
 * A structure containing the details of an enqueued packet that is waiting for and ARP Reply
 */
struct packet {
